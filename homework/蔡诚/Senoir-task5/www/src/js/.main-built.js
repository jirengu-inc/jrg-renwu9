...
define('com/auto-Carousel',['jquery'], function($) {
...
define('com/simple-tab',['jquery'], function($) {
    var Tab = (function() {
        function _Tab($ct) {
            this.$ct = $ct
            this.init()
        ...
        _Tab.prototype.bind = function() {
            ...
            this.$window.on('scroll', function() {
                ...
                clock = setTimeout(function() {
                    var clear = true
                    for (let i = 0; i < _this.itemCount; i++) {
...
/** AMD **/
define('app/index',['jquery', 'com/auto-Carousel', 'com/simple-tab', 'com/waterFall', 'com/goTop'], function($, Carousel, Tab, WaterFall, GoTop) {
    Tab.init($('.navbar'))
